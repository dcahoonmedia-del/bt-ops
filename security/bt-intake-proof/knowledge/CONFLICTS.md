...
| How Daniel approves or sends | Isolated Gmail review used CASE=/DRAFT= markers | **Conversational Lead Desk: natural speech → intent; backend binds. No magic phrase allowlist** | Daniel 2026-09-12. Phase E exact packet binding still wins for any send |
