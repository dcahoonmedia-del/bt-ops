...
| How Daniel approves or sends | Isolated Gmail review used CASE=/DRAFT= markers; later Python phrase helper inferred speech | **ChatGPT interprets speech and sends a private Gmail control message; backend binds. Python utterance helper is fallback only. Custom MCP is not the iPhone path** | Daniel 2026-09-12. Phase E exact packet binding still wins for any send |
