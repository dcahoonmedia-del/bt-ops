...
CLASS_DESK_TRANSPORT = "desk_transport"
...
MARKER_DESK_QUEUE = "BT-INTAKE-PROOF-DESK-QUEUE-E9A8"
MARKER_DESK_CASE = "BT-INTAKE-PROOF-DESK-CASE-E9A8"
MARKER_DESK_HEALTH = "BT-INTAKE-PROOF-DESK-HEALTH-E9A8"
MARKER_DESK_SEND = "BT-DESK-ROUNDTRIP-SEND-E9A8"
MARKER_DESK_RT_CASE = "BT-INTAKE-PROOF-CASEMGR-DESK-RT-E9A8"
DESK_SEND_SUBJECT = "BT-DESK-ROUNDTRIP-SEND-E9A8 internal send test"
DESK_SEND_BODY = """BT-DESK-ROUNDTRIP-SEND-E9A8
...
B&T office
"""
DESK_SEND_TIMING = "immediate_supervised"
DESK_PACKET_MARKERS = (
    MARKER_DESK_RESULT,
    MARKER_DESK_QUEUE,
    MARKER_DESK_CASE,
...
OFFICE_OWNER_KEYS = ("brenda", "ally", "office")
