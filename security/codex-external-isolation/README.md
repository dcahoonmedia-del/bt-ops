...
Latest isolated run: **PASS**. ChatGPT device-code login authenticated only the disposable container, then Test 0 submitted synthetic email as `ExternalMessage`. See `RESULTS.md`.
